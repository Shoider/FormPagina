...
function EditableTableUsua({ initialData, onDataChange }) {
  ...
  const columns = [
    { field: 'No', headerName: 'N°', type: 'number', width: 40, align: 'center', headerAlign: 'center', editable: false },
    { field: 'SO', headerName: 'Nombre(s) de Usuario(s) Zona(s) Origen', type: 'string', width: 150, align: 'center', headerAlign: 'center', editable: true },
    ...
    { field: 'IPO', headerName: 'Segmento(s)/IP(s) Origen', type: 'string', width: 200, align: 'center', headerAlign: 'center', editable: true },
    ...
    { field: 'FRD', headerName: 'Rol de Anfitrión(es) Destino', type: 'string', width: 200, align: 'center', headerAlign: 'center', editable: true },
